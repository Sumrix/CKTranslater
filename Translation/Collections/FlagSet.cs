namespace Translation.Collections
{
    ...
    public struct FlagSet
    {
        ...
        public bool Has(uint flag) => (this.Value & flag) != 0;

        /// <summary>
        /// Установить флаг
        /// </summary>
        /// <param name="flag">Устанавливаемый флаг</param>
        public void Set(uint flag) => this.Value |= flag;

        /// <summary>
        /// Сбросить флаг
        /// </summary>
        /// <param name="flag">Сбрасываемый флаг</param>
        public void Reset(uint flag) => this.Value &= flag;
        ...
        public override bool Equals(object obj) => obj is FlagSet other && this.Value == other.Value;
        ...
        /// </summary>
        /// <returns>True - объекты равны, False - нет</returns>
        public static bool operator ==(FlagSet left, FlagSet right) => left.Value == right.Value;
