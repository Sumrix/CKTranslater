...
## Getting Started
This app was built using WinUI 3 Preview 4.
...
```
.
├── CKTranslator/ - WinUI 3 Desktop app
...
├── CKTranslator.Core/ - core project (.NET Standard)
│ ├── Contracts/ - class interfaces
│ ├── Helpers/ - static helper classes
│ ├── Models/ - business models
│ └── Services/ - services implementations
├── CKTranslator (Package)/ - MSIX packaging project
